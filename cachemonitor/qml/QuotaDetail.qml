...
Rectangle {
    ...
    x: Math.max(8, Math.min((parent ? parent.width : 404) - width - 8,
                           anchor.x + width + 20 < (parent ? parent.width : 404) ? anchor.x + 20 : anchor.x - width - 20))
    y: Math.max(8, Math.min((parent ? parent.height : 800) - height - 8,
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            ToolButton {
                ...
                visible: card.plot.detailPinned
